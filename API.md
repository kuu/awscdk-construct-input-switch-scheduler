...
| <code><a href="#awscdk-construct-input-switch-scheduler.EventBridgeSchedule.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="awscdk-construct-input-switch-scheduler.EventBridgeSchedule.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="awscdk-construct-input-switch-scheduler.EventBridgeSchedule.with.parameter.mixins"></a>
...
| <code><a href="#awscdk-construct-input-switch-scheduler.InputSwitchScheduler.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="awscdk-construct-input-switch-scheduler.InputSwitchScheduler.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="awscdk-construct-input-switch-scheduler.InputSwitchScheduler.with.parameter.mixins"></a>
...
| <code><a href="#awscdk-construct-input-switch-scheduler.Lambda.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="awscdk-construct-input-switch-scheduler.Lambda.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="awscdk-construct-input-switch-scheduler.Lambda.with.parameter.mixins"></a>
